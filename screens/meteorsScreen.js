...
import { SafeAreaView, Text,View,FlatList, Platform,StyleSheet,Image, ImageBackground,Dimensions } from 'react-native'
...
{ 
    ...
    getMeteors=()=>{
    axios
    .get("https://api.nasa.gov/neo/rest/v1/feed?api_key=g0hamBzre3ORkeNIidgpi3WgcLP9ulcvVWeGCofK")
    .then(response=>{
         this.setState({
